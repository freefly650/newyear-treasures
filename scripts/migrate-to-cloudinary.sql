-- Run this ONLY if you have an existing toys table with image_data/image_content_type
...
--
-- 1. Add new column
ALTER TABLE toys ADD COLUMN IF NOT EXISTS image_url TEXT;
-- 2. (Optional) Backfill image_url from your migration script that uploads to Cloudinary.
-- 3. Drop old columns
ALTER TABLE toys DROP COLUMN IF EXISTS image_data;
ALTER TABLE toys DROP COLUMN IF EXISTS image_content_type;
